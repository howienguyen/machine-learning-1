"""
Machine Learning 1, FSB

Music Genre Prediction Using Log-Mel Spectrograms and CNNs

Log-Mel CNN training script

By Nguyễn Sỹ Hùng (25MSA33055), 2026
...
# Default cache root follows settings.json when present.
...
with tf.device(RUNTIME_DEVICE):
    ...
    # Keep optimizer state aligned across staged training.
