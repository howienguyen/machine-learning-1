...
# # Log-Mel CNN v2.2
#
# Gap-aware early-stopping upgrade of `logmel_cnn_v2_1.py` targeting stronger
# generalization control while keeping the same model backbone and data path.
#
...
# python MelCNN-MGR/model_training/logmel_cnn_v2_2.py --pretrained-model MelCNN-MGR/models/logmel-cnn-demo/best_model_macro_f1.keras
# python MelCNN-MGR/model_training/logmel_cnn_v2_2.py --pretrained-model MelCNN-MGR/models/logmel-cnn-demo/best_model_macro_f1.keras --pretrained-mode backbone_only --freeze-backbone-epochs 3
...
CLI_PARSER = argparse.ArgumentParser(
    description="Train Log-Mel CNN v2.2 with gap-aware early stopping from scratch or warm-start from an existing .keras checkpoint.",
)
...
def build_model(n_classes: int) -> keras.Model:
    ...
    return keras.Model(inputs, outputs, name="logmel_cnn_v2_2")
...
model_path = RUN_DIR / "logmel_cnn_v2_2.keras"
...
fig.suptitle("Training history — Log-Mel CNN v2.2")
plt.tight_layout()
plt.show()
...
ax.set_title("Confusion matrix — test set (logmel_cnn_v2_2)")
plt.tight_layout()
plt.show()
...
report_path = RUN_DIR / "run_report_logmel_cnn_v2_2.json"
