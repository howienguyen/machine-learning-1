#!/usr/bin/env python3
"""
Example: Log-Mel CNN v20 Genre Inference
==========================================
Demonstrates how to use the inference module to classify audio files
by music genre using a trained Log-Mel CNN v20 model.

Usage
-----
    # Predict on specific files
    python MelCNN-MGR/examples/inference_logmel_v20_example.py \
        --run-dir MelCNN-MGR/models/logmel-cnn-v20-20260308-120000 \
    ...
    # Three-crop mode (averages 3 × 10 s crops for more robust predictions)
    python MelCNN-MGR/examples/inference_logmel_v20_example.py \
        --run-dir MelCNN-MGR/models/logmel-cnn-v20-20260308-120000 \
...
from inference_logmel_v20 import LogMelV20Inference, PredictionResult
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run genre inference using a trained Log-Mel CNN v20 model.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--mode", choices=["single_crop", "three_crop"], default="single_crop",
        help="Inference mode: single_crop (default) or three_crop (averages 3 crops).",
    )
    ...
    engine = LogMelV20Inference(args.run_dir)
