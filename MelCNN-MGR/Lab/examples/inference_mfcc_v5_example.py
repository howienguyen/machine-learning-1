#!/usr/bin/env python3
"""
Example: MFCC CNN v5 Genre Inference
=====================================
Demonstrates how to use the inference module to classify audio files
by music genre using a trained MFCC CNN v5 model.
...
-----
    ...
    # Three-crop mode (slightly more robust for longer tracks)
    python MelCNN-MGR/examples/inference_mfcc_v5_example.py \
        --run-dir MelCNN-MGR/models/mfcc-cnn-20260308-120000 \
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run genre inference using a trained MFCC CNN v5 model.",
    )
    parser.add_argument(
    ...
    engine = MFCCCNNInference(args.run_dir)
