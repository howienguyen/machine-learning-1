#!/usr/bin/env python3
"""
Example: Log-Mel CNN v10 Genre Inference
==========================================
Demonstrates how to use the inference module to classify audio files
by music genre using a trained Log-Mel CNN v10 model.
...
-----
    ...
    # Three-crop mode (averages 3 × 30 s crops for more robust predictions)
    python MelCNN-MGR/examples/inference_logmel_v10_example.py \
        --run-dir MelCNN-MGR/models/logmel-cnn-v10-20260308-120000 \
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run genre inference using a trained Log-Mel CNN v10 model.",
    )
    parser.add_argument(
    ...
    engine = LogMelV10Inference(args.run_dir)
